		...
		<PromptInputTools>
			...
			>
				<DropdownMenuTrigger asChild>
					<PromptInputButton
						type="button"
						className="h-8 w-8 shrink-0 p-0 rounded-full border border-foreground/10 bg-foreground/[0.04] text-muted-foreground hover:bg-foreground/10 hover:text-foreground hover:border-foreground/15"
					...
					{menuView === "root" ? (
							...
							{showWebSearchButton && (
								<DropdownMenuItem
									...
									className={cn(
										...
										isWebSearchEnabled && "text-primary focus:text-primary",
									)}
								>
						...
						<>
							...
							<DropdownMenuItem
								...
								className={cn(
									"cursor-pointer gap-2",
									!agentId && "text-primary focus:text-primary",
								)}
							>
								<Check
									className={cn(
										"h-4 w-4 shrink-0",
										agentId ? "opacity-0" : "opacity-100",
									)}
								/>
								<span>None</span>
							</DropdownMenuItem>
