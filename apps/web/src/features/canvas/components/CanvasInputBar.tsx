		...
		<TooltipProvider delayDuration={200}>
			...
			>
				<div className="pointer-events-auto relative mx-auto w-full max-w-3xl">
					<div className="glow-rail rounded-3xl border border-border/40 bg-background/45 shadow-2xl backdrop-blur-3xl transition-shadow duration-300 sm:rounded-[2.5rem]">
						<CanvasInputPrompt
							prompt={prompt}
