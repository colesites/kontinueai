...
import { SubmitGlowButton } from "../../../components/ai-elements/submit-glow-button";
				...
				<Tooltip>
					<TooltipTrigger asChild>
						<button
							...
							className={cn(
								"mb-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-foreground/10 bg-foreground/[0.04] text-foreground/45 transition-colors hover:bg-foreground/10 hover:text-foreground hover:border-foreground/15 sm:h-11 sm:w-11",
