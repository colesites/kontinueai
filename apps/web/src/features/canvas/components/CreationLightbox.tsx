	...
	return (
		<div className="fixed inset-0 z-100 flex items-center justify-center bg-black/80 backdrop-blur-sm">
			...
			<div
				...
				className="relative z-10 mx-4 flex max-h-[90vh] max-w-5xl flex-col overflow-hidden rounded-2xl bg-card ring-1 ring-foreground/10 shadow-2xl lg:flex-row"
			>
				{/* Close button */}
				<button
					type="button"
				...
				<div className="flex w-full flex-col gap-4 overflow-y-auto p-6 lg:w-80">
					...
					<div className="mt-auto flex items-center gap-2 pt-4">
						<Button
							...
							className={`gap-1.5 ${isLiked ? "border-destructive/40 text-destructive" : ""}`}
						>
							<Heart
