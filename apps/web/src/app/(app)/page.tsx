	...
	return (
		<>
			...
			<div className="relative flex h-full flex-col">
				{/* Ambient field — calm, theme-tinted glow behind the composer */}
				<div
					aria-hidden
					className="pointer-events-none absolute inset-0 -z-10 overflow-hidden"
				>
					<div className="absolute left-1/2 top-[-12%] h-[55vh] w-[80vw] -translate-x-1/2 rounded-full bg-primary/10 blur-[130px]" />
					<div className="absolute bottom-[-18%] right-[2%] h-[42vh] w-[42vw] rounded-full bg-accent/10 blur-[130px]" />
				</div>
