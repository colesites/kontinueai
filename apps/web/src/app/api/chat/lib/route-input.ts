...
import { type AgentId, isAgentId } from "@repo/ai/lib/agents";
...
export async function getAuthContext(): Promise<{
	...
	return {
		...
		getToken:
			typeof authResult.getToken === "function"
				? authResult.getToken
				: undefined,
	};
}

export async function parseChatRouteInput(
	req: Request,
): Promise<ChatRouteInput> {
