...
export const metadata: Metadata = pageMetadata({
	title: "Kontinue AI Privacy Policy",
	description:
		"How Kontinue AI collects, uses, shares, secures and retains personal information and conversation data.",
	...
	return (
		<div className="container mx-auto px-4 py-16 max-w-4xl">
			...
			<div className="space-y-6 text-muted-foreground">
				...
				<PrivacyDataAndUse />
				<PrivacyRightsAndContact />
			</div>
		</div>
	);
}

function PrivacyDataAndUse() {
	return (
		<>
			<section>
				...
				<p className="mt-4">
					...
					collect, use, and share your personal information as described below.
					If you do not agree to this Policy, please do not use the Site or the
					Services.
				</p>
			</section>
			...
			<section>
				...
				<ul className="list-disc pl-6 space-y-2">
					...
					<li>
						<strong>Chat Data:</strong> When you import conversations using our
						supported shared-link or export-file methods, we store the resulting
					...
					<li>
						...
						plan, our payment processor collects billing details.
					</li>
					<li>
			...
			<section>
				...
				<ul className="list-disc pl-6 space-y-2">
					<li>
						<strong>To Provide Services:</strong> Process your requests, manage
						your account, enable chat imports, facilitate model switching, and
			...
			<section>
				...
				<ul className="list-disc pl-6 space-y-2">
					<li>
						<strong>AI Service Providers:</strong> When you use our Services, we
						send your prompts to third-party AI providers (OpenAI, Anthropic,
						Google, etc.) to generate responses. Each provider has their own
						privacy policy.
					</li>
					<li>
					...
					<li>
						...
						protect rights and safety, or in connection with legal proceedings.
					</li>
					<li>
...
function PrivacyRightsAndContact() {
	return (
		<>
			<section>
				<h2 className="text-2xl font-bold text-foreground mb-4">
				...
				<ul className="list-disc pl-6 space-y-2">
					...
					<li>
						<strong>Export Data:</strong> You can export your conversations and
						data at any time.
					</li>
					<li>
