...
export const metadata: Metadata = pageMetadata({
	title: "Kontinue AI Terms of Service",
	description:
		"Terms governing use of Kontinue AI, subscriptions, user content, external AI providers and connected services.",
	...
	return (
		<div className="container mx-auto px-4 py-16 max-w-4xl">
			...
			<div className="space-y-6 text-muted-foreground">
				...
				<TermsUseAndBilling />
				<TermsProductAndBilling />
				<TermsLegalAndContact />
			</div>
		</div>
	);
}

function TermsUseAndBilling() {
	return (
		<section>
			...
			<p>
				Welcome to Kontinue AI! These Terms of Service ("Terms") govern your use
				of our website at https://kontinueai.com (the "Site") and all related
				services, software, and applications (collectively, the "Services")
				provided by Kontinue AI ("we," "our," "us").
			</p>
			<p className="mt-4">
			...
			<p className="mt-4">
				<strong>You must be at least 13 years old to use our Services.</strong>{" "}
				If you are under 18, you must have your parent or guardian's permission
				to use the Services.
			</p>
		</section>
	);
...
function TermsProductAndBilling() {
	return (
		<>
			<section>
				<h2 className="text-2xl font-bold text-foreground mb-4">
				...
				<p>Kontinue AI provides a platform that allows you to:</p>
				<ul className="list-disc pl-6 space-y-2 mt-2">
					<li>
						Import conversations from supported AI chat platforms using
						available shared-link or export-file methods
					</li>
					<li>Organize and manage your AI conversations in one place</li>
					<li>Switch between different AI models for different tasks</li>
					<li>
						Choose another model for the next response in the same conversation
					</li>
			...
			<section>
				...
				<p>
					You retain ownership of all content you upload, import, or create
					through our Services ("User Content"). By using our Services, you
					grant us a license to store, process, and display your User Content
			...
			<section>
				...
				<p>
					Our Free plan provides limited access to our Services with usage
					restrictions.
				</p>
				...
				<ul className="list-disc pl-6 space-y-2 mt-2">
					...
					<li>Your subscription will automatically renew unless you cancel</li>
			...
			<section>
				...
				<p>
					Our Services integrate with third-party AI providers (OpenAI,
					Anthropic, Google, etc.). When you use these AI models through our
					platform:
				</p>
				<ul className="list-disc pl-6 space-y-2 mt-2">
					<li>
						Your prompts and conversations are sent to the respective AI
						provider
					</li>
					<li>
					...
					<li>
						The availability and performance of AI models depends on these
		...
		<>
			<section>
				...
				<p>
					...
					and other content (excluding User Content), are owned by Kontinue AI
			...
			<section>
				...
				<p>
					...
					account at any time by contacting us or through your account settings.
				</p>
				<p className="mt-4">
					Upon termination, you should export any User Content you wish to
					retain, as we may delete your data after account closure.
				</p>
			</section>
			...
			<section>
				...
				<p className="mt-4">
					...
					error-free, or secure. We do not warrant the accuracy, completeness,
					or reliability of any content or AI-generated responses.
				</p>
			</section>
			...
			<section>
				...
				<p className="uppercase font-semibold">
					TO THE MAXIMUM EXTENT PERMITTED BY LAW, KONTINUE AI SHALL NOT BE
				...
				<p className="mt-4 uppercase font-semibold">
					...
					THE PAST TWELVE MONTHS, OR $100, WHICHEVER IS GREATER.
				</p>
			</section>
			...
			<section>
				...
				<p>
					You agree to indemnify and hold harmless Kontinue AI from any claims,
					damages, losses, liabilities, and expenses (including legal fees)
					arising from your use of the Services, your User Content, or your
			...
			<section>
				...
				<p>
					...
					changes by posting the updated Terms on our Site. Your continued use
					of the Services after changes constitutes acceptance of the modified
					Terms.
				</p>
			</section>
			...
			<section>
				...
				<p>
					...
					the American Arbitration Association, except for small claims court
					matters.
				</p>
				<p className="mt-4 uppercase font-semibold">
